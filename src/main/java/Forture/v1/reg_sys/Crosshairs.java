 ...
 * representation of the stockInfo. The pointer is held as three separate shapes
 * in a <code>Shape[]</code> and is animated by updating the shape and calling
 * repaint, simulating an animation.
 *
...
public class Crosshairs extends MouseInputAdapter
{
     ...
     * 
     * @param padd
     *            - padding to take into account for x- and y- axis calcs
     * @param labelPadd
     *            - labelPadding to account for in x-axis calculations
     * @param pointWid
     *            - width of points
     * @param pointList
     *            - all the graph-translated points
     * @param g
     *            - graphics component used in stockGraph
     * @param panel
     *            - context to which this object should be added to
     */
    public Crosshairs(
        int padd,
        int labelPadd,
        ...
        StockGraph panel )
    {
        ...
        shape[1] = new Line2D.Double( padding + labelPadding + 1,
            y,
            panel.getWidth() - padding,
            y );
        shape[2] = new Ellipse2D.Double( x - pointWidth / 2,
            y - pointWidth / 2,
            pointWidth,
            pointWidth );
    ...
    /**
     * Constructor meant for JUnit Testing
     * @param padd
     *            - padding to take into account for x- and y- axis calcs
     * @param labelPadd
     *            - labelPadding to account for in x-axis calculations
     ...
     * 
     * @param g
     *            - graphics compenent used to draw StockGraph
     */
